...
electron.contextBridge.exposeInMainWorld('electron', {
  ...
  loadImportAgentWorkspace: input => ipcInvoke('loadImportAgentWorkspace', input),
  createImportAgentSession: input => ipcInvoke('createImportAgentSession', input),
  sendImportAgentMessage: input => ipcInvoke('sendImportAgentMessage', input),
  abortImportAgentSession: input => ipcInvoke('abortImportAgentSession', input),
  applyImportAgentPlan: input => ipcInvoke('applyImportAgentPlan', input),
