...
const kvTestMatchersSection: ScriptDocumentationSection = {
  ...
  entries: [
    { label: 'not.<matcher>(...)', detail: 'Invert any matcher on the returned expectation.' },
    ...
    { label: 'toBeDefined()', detail: 'Assert that the value is not undefined.' },
    { label: 'toContain(value)', detail: 'Assert that an array contains the given value or a string contains the given substring.' },
    ...
    { label: 'toMatchObject(expected)', detail: 'Assert that an object or array matches the provided partial structure.' },
    { label: 'toBeGreaterThan(expected)', detail: 'Assert that a number is greater than the given value.' },
    { label: 'toBeGreaterThanOrEqual(expected)', detail: 'Assert that a number is greater than or equal to the given value.' },
    { label: 'toBeLessThan(expected)', detail: 'Assert that a number is less than the given value.' },
    { label: 'toBeLessThanOrEqual(expected)', detail: 'Assert that a number is less than or equal to the given value.' },
    { label: 'toStartWith(prefix)', detail: 'Assert that a string starts with the given prefix.' },
    { label: 'toEndWith(suffix)', detail: 'Assert that a string ends with the given suffix.' },
    {
