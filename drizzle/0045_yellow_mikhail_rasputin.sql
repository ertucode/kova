...
INSERT INTO `__new_folder_explorer_tabs`("id", "item_type", "item_id", "request_meta_tab", "position", "is_pinned", "is_active", "created_at", "updated_at") SELECT "id", "item_type", "item_id", "request_meta_tab", "position", "is_pinned", "is_active", "created_at", "updated_at" FROM `folder_explorer_tabs`;--> statement-breakpoint
