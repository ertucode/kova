...
ALTER TABLE `request_examples` ADD `graphql_query` text DEFAULT '' NOT NULL;--> statement-breakpoint
ALTER TABLE `request_examples` ADD `graphql_variables` text DEFAULT '' NOT NULL;--> statement-breakpoint
...
INSERT INTO `__new_requests`(
	"id", "name", "request_type", "method", "url", "path_params", "search_params", "auth_json", "pre_request_script", "post_request_script", "test_script", "response_visualizer", "response_table_accessor", "preferred_response_body_view", "prefers_response_visualizer", "headers", "body", "body_type", "raw_type", "websocket_subprotocols", "websocket_on_open_message", "websocket_auto_send_enabled", "websocket_auto_send_message", "websocket_auto_send_interval_seconds", "save_to_history", "created_at", "deleted_at", "graphql_query", "graphql_variables"
) SELECT
	"id", "name", "request_type", "method", "url", "path_params", "search_params", "auth_json", "pre_request_script", "post_request_script", "test_script", "response_visualizer", "response_table_accessor", "preferred_response_body_view", "prefers_response_visualizer", "headers", "body", "body_type", "raw_type", "websocket_subprotocols", "websocket_on_open_message", "websocket_auto_send_enabled", "websocket_auto_send_message", "websocket_auto_send_interval_seconds", "save_to_history", "created_at", "deleted_at", '' AS "graphql_query", '' AS "graphql_variables"
FROM `requests`;--> statement-breakpoint
INSERT INTO `__new_websocket_saved_messages`(
	"id", "request_id", "body", "created_at", "updated_at", "deleted_at"
) SELECT
	"id", "request_id", "body", "created_at", "updated_at", "deleted_at"
FROM `websocket_saved_messages`;--> statement-breakpoint
INSERT INTO `__new_websocket_history`(
	"id", "request_id", "request_name", "url", "request_headers", "request_variables_json", "history_size_bytes", "connected_at", "disconnected_at", "close_code", "close_reason", "response_error", "created_at"
) SELECT
	"id", "request_id", "request_name", "url", "request_headers", "request_variables_json", "history_size_bytes", "connected_at", "disconnected_at", "close_code", "close_reason", "response_error", "created_at"
FROM `websocket_history`;--> statement-breakpoint
INSERT INTO `__new_websocket_history_messages`(
	"id", "history_id", "direction", "body", "mime_type", "size_bytes", "timestamp", "created_at"
) SELECT
	"id", "history_id", "direction", "body", "mime_type", "size_bytes", "timestamp", "created_at"
FROM `websocket_history_messages`;--> statement-breakpoint
INSERT INTO `__new_websocket_examples`(
	"id", "request_id", "name", "position", "request_headers", "request_body", "message_count", "created_at", "updated_at", "deleted_at"
) SELECT
	"id", "request_id", "name", "position", "request_headers", "request_body", "message_count", "created_at", "updated_at", "deleted_at"
FROM `websocket_examples`;--> statement-breakpoint
INSERT INTO `__new_websocket_example_messages`(
	"id", "example_id", "direction", "body", "mime_type", "size_bytes", "timestamp", "created_at"
) SELECT
	"id", "example_id", "direction", "body", "mime_type", "size_bytes", "timestamp", "created_at"
FROM `websocket_example_messages`;--> statement-breakpoint
...
CREATE INDEX `requests_request_type_idx` ON `requests` (`request_type`);--> statement-breakpoint
...
ALTER TABLE `request_history` ADD `graphql_query` text DEFAULT '' NOT NULL;--> statement-breakpoint
ALTER TABLE `request_history` ADD `graphql_variables` text DEFAULT '' NOT NULL;
